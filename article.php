        ...
        <h2>Commentaires</h2>
          ...
          <?php 
            ...
            <div class="mb-4">
              ...
              <p class="m-0 p-0">
                <?php $date =DateTime::createFromFormat ('Y-m-d H:i:s', $comment['comment_date'])->format('d/m/Y');?>
                <small>Ecrit par <?php echo $comment['author']?> le <?php
                echo $date?></small>
              </p>
            </div>
          <?php endforeach;
          ...
          <div class="pt-5" id="comments">
            ...
            <?php if(isset($_SESSION['user'])): ?>
              <form action="add_comment.php?id=<?php echo $article['id']; ?>" method="post">
                ...
                <textarea name="comment" id="comments" rows="4" class="form-control mb-3 mt-1"></textarea>
