...
$insertArticleCommentComment = $bdd->prepare("
...
foreach ($articles as $article) {
    ...
    for ($j = 0; $j < $iteration; $j++) {
        ...
        $insertArticleCommentComment->bindValue(':article_id', $article['id']);
        $insertArticleCommentComment->bindValue(':category_id', $categorie['id']);
        $insertArticleCommentComment->execute();
    }
}
